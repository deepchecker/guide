...
Установка обычно занимает около 20 минут.
...
- Заходим в админку чекера по ссылке **/settings**, заполняем поля **'Имя бота (указываем без @)'** и **'Токен'**, жмем кнопку **'Привязать вебхук Telegram'**.  

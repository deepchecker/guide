...
Приложение во время пиковой нагрузки создает большую нагрузку на сторонние API. В связи с чем сразу после установки, перед добавлением мнемоников рекомендуется арендовать от 10 до 20 ipv4 http-прокси (желательно приватных). Ниже список сервисов, где их можно приобрести:

- https://proxyline.net/ipv4/
- https://proxy6.net/
- https://proxy-seller.ru

После установки чекера - не забудьте добавить прокси через админ - панель.
...
Приобретите доменное имя у любого удобного вам регистратора и поменяйте A-запись домена на IP вашего VPS сервера.

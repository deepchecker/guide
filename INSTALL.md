...
Приложение во время пиковой нагрузки создает большую нагрузку на сторонние API. В связи с чем сразу после установки, перед добавлением Seed-фраз рекомендуется арендовать от 10 до 20 ipv4 http-прокси (желательно приватных). Ниже список сервисов, где их можно приобрести:
